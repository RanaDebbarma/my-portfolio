...
const ThemeToggle = () => {
  ...
  return (
    <div
      onClick={() => toggleTheme()}
      className="hover:bg-accent/10 border border-foreground/20 hover:border-accent/40 group convex active:scale-95 isolate cursor-pointer p-3 relative rounded-full overflow-hidden duration-300 ease-in-out"
    >
      {
        theme === "light"
          ? <svg
            className="h-6 fill-foreground group-hover:text-accent duration-300 ease-in-out"
