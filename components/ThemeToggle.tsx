...
const ThemeToggle = () => {
  ...
  return (
    <div
      onClick={() => toggleTheme()}
      className="h-12 w-12 p-2 flex justify-center items-center hover:bg-accent/10 border border-foreground/20 hover:border-accent/40 group convex active:scale-95 isolate cursor-pointer relative rounded-full overflow-hidden duration-300 ease-in-out"
    >
      {
        theme === "light"
          ? <svg
            className="h-full fill-foreground group-hover:text-accent duration-300 ease-in-out"
