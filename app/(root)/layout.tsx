...
>>>>>>> 1bdc3a935c77943bafcc58fa745bb5d1cfb4492a
        ...
        {/* content */}
        <div
          className="overflow-y-auto border border-foreground/10 bg-secondary shadow-[0_16px_24px_rgba(0,0,0,0.2)] rounded-4xl flex-1 px-4 py-2"
        >
          {children}
        </div>
      </div>
